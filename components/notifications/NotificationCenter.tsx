      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-80 sm:w-96 max-w-[calc(100vw-1rem)] bg-gray-900/95 backdrop-blur-sm border border-gray-800 rounded-xl shadow-2xl overflow-hidden z-50"
          >
            {/* Header */}
